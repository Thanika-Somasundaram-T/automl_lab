...
def train_one_epoch(model, optimizer_w, optimizer_alpha, dataloaders, dataset_names, criterion, grad_clip, max_batches_per_dataset=40):
    """
...
def evaluate(model, dataloaders, dataset_names, criterion, max_batches_per_dataset=40):
    """
...
def fit(config, loaders, seed=42):
    """
    ...
    for epoch in epoch_bar:
        ...
        val_loss, val_acc = evaluate(model, val_loaders, dataset_names, criterion)
